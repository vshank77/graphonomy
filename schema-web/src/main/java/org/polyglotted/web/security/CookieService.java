...
/**
 * This is a naive Cookie implementation. In a true enviorment, one would need to create a more secure cookie that
 * cannot be spoofed. Use SHA, Salts what have you. For the scope of this example, it will have to do though.
 */
public interface CookieService {

    static final String COOKIE_NAME = "AUTH_COOKIE";

    String extractUserName(Cookie[] cookies);
